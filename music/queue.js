class Queue {
    ...
    create(guildId) {
        const queue = {
            ...
            volume: 100,
            filters: {},
            loop: 'none',              // Legacy compat: 'none' | 'track' | 'queue'
            repeatMode: 'once',        // New unified mode: 'once' | 'loop' | 'queue' | 'repeatN'
            repeatCount: 1,            // When repeatMode === 'repeatN', how many times total to play
            currentRepeat: 0,          // Counter for 'repeatN' (how many times played so far)
            autoplay: false,
            paused: false,             // Pause state for Manual mode control
            textChannel: null,
        };
